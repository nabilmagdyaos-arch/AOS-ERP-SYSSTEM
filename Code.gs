...
// Lists, Food Cost, Food Cost Log, Accommodation, Ops Roster, Ops Daily, Library) gets an
// integer revision counter here, bumped every time that sheet is written. A client that last
